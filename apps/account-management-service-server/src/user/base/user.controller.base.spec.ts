...
const CREATE_INPUT = {
  battingAverage: 42.42,
  bestBowling: "exampleBestBowling",
  bowlingAverage: 42.42,
  createdAt: new Date(),
  economyRate: 42.42,
  email: "exampleEmail",
  fieldingCatches: 42,
  fieldingRunouts: 42,
  fieldingStumpings: 42,
  fifties: 42,
  firstName: "exampleFirstName",
  followedUsers: "exampleFollowedUsers",
  followingUsers: "exampleFollowingUsers",
  highestScore: 42,
  hundreds: 42,
  id: "exampleId",
